...
$file = __DIR__ . '/../core/class/simulationpresenceintelligentbe.class.php';
...
if (!preg_match('/class\s+simulationpresenceintelligentbeCmd\s+extends\s+cmd/', $source)) {
    $problems[] = 'Classe simulationpresenceintelligentbeCmd absente — impossible de créer un équipement.';
}
...
foreach (simulationpresenceintelligentbeLamps::$_generics as $role => $list) {
